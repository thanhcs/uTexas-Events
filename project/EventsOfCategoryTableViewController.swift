//
//  EventsOfCategoryTableViewController.swift
//  project
//
...
class EventsOfCategoryTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "CategoryToEvent" {
